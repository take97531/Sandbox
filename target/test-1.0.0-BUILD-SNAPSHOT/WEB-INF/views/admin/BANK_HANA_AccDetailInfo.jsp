...
<html>
	...
	$(document).ready(function(){
		...
		$('#popupBtn').on("click",function(){
			 var url="addPopup_AccDetailInfo"
			 var name="addPopup_AccDetailInfo"
			//var value = "HANA"
		...
		<div style="border: 2px; float: left; width: 70%; margin: 10;">
					<form action="/admin/delete" method="post">
						...
						<table class="table table-hover" >
							<tr><th><input type="checkbox" name="all_check" class="check-all"/></th><th>날짜</th><th>은행명</th><th>계좌번호</th><th>입/출금</th><th>처리금액</th><th>잔액</th><th>가맹점</th></tr>
							
							<c:forEach items="${list}" var = "list">
								<tr>
									<td><input type="checkbox" name="idxArr" value="${list.bank_no}" class="check-one"/></td>
									<!-- <td><c:out value="${list.bank_no}" /></td>-->
