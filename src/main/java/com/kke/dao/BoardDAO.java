...
public interface BoardDAO {
	...
	public void write3(ApiVO api) throws Exception;
	
	public void writeAccInfoAuto(List<AccInfoVO> voList, String bank_num) throws Exception;
	public int checkAccNum(String acc_num, String bank_num) throws Exception;
	public void writeAccDetailInfoAuto(ApiVO api) throws Exception;
	public int checkBalance (String acc_num, int i) throws Exception;
